...
from PyQt5.QtWidgets import (QApplication, QWidget, QLabel, QPushButton,QVBoxLayout, QLineEdit, QHBoxLayout, QMessageBox)
...
class TestWin(QWidget):
    ...
    def initUI(self):
       ...
       self.line_test1.setValidator(QIntValidator(0, 200, self))
       self.line_test2 = QLineEdit(txt_hinttest2)
       self.line_test2.setValidator(QIntValidator(0, 200, self))
       self.line_test3 = QLineEdit(txt_hinttest3)
       self.line_test3.setValidator(QIntValidator(0, 200, self))
